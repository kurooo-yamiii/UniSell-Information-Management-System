...
namespace WebUniform.Migrations
{
    ...
    [Migration("20240705095821_AddUniformUserIdFinal")]
    partial class AddUniformUserIdFinal
    {
            ...
            modelBuilder.Entity("WebUniform.Models.Slack", b =>
                {
                    ...
                    b.HasOne("WebUniform.Models.Slack", null)
            ...
            modelBuilder.Entity("WebUniform.Models.Uniform", b =>
                {
                    ...
                    b.HasOne("WebUniform.Models.Uniform", null)
                        .WithMany("RelatedItems")
